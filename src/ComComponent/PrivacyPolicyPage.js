...
//     <>
//       <div>
//         <p className="text-center text-4xl text-gray-800 mt-3">Privacy Policy</p>
//       </div>
//     </>
//   );
// };
        ...
        <div className="bg-white p-6 rounded shadow-md">
          <p className="text-gray-700">
            ...
            <p>
              ...
              our Terms and Conditions, which is accessible at Drag Racing
              Lights unless otherwise defined in this Privacy Policy.
            </p>{" "}
            <p>
            ...
            <p>
              This privacy policy page was created at and modified/generated by{" "}
              Privacy Policy.
            </p>
          </p>
        </div>
