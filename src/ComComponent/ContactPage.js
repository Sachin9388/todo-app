...
//     <>
//     <div>
//         <p  className='text-center text-4xl text-gray-800 mt-3' >Contact Page</p>
//     </div>
//     </>
//   )
// }
...
const Contact = () => {
  return (
    <>
      <section className="bg-white mt-10 overflow-hidden relative z-10">
        <div className="container">
        <p  className='text-center text-4xl text-gray-800 mb-20' >Contact Page</p>
          <div className="flex flex-wrap -mx-4 lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                <h2 className="mb-6 ml-3 text-[32px] font-bold uppercase text-dark sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                  GET IN TOUCH WITH US
                </h2>
                <p className="text-base ml-3 leading-relaxed mb-9 text-body-color">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do eius tempor incididunt ut labore e dolore magna aliqua. Ut
                  enim adiqua minim veniam.
                </p>
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color">
                       Parasmani Society Ghatlodiya Ahmedabad,Gujrat. India
                    </p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="relative mr-5 p-8 bg-white rounded-lg shadow-lg sm:p-12">
                <form>
                  <input
                    type="text"
                    name="name"
                    placeholder="Your Name"
                    className="border-[f0f0f0] mb-6 w-full rounded border py-3 px-[14px] text-base text-body-color outline-none focus:border-primary focus-visible:shadow-none"
                  />
                  <input
                    type="email"
                    name="email"
                  ...
                  <textarea
                    ...
                    name="details"
                    defaultValue=""
                    className="border-[f0f0f0] mb-6 w-full resize-none rounded border py-3 px-[14px] text-base text-body-color outline-none focus:border-primary focus-visible:shadow-none"
                  />
                  <div>
                    <button
                      type="submit"
                      className="w-full p-3  text-black transition  border rounded border-primary bg-primary hover:bg-blue-500 hover:text-white"
                    >
                      Send Message
                    </button>
                  </div>
